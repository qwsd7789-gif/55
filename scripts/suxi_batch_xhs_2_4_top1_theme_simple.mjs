...
const prompt = '参考这张图片的主题，重新生成一张新的图片。要求：保留核心元素，改变背景、光线，不要和原图一样。';
...
const runId = `suxi-batch-2to4-top1-theme-simple-${Date.now()}`;
