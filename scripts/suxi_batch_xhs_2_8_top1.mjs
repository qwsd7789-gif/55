...
const prompt = '提取爆款元素 重绘制图片 更换背景';
...
const wanted = [1,2,3,4,5,6,7]; // 第2到第8篇（0-based）
...
const runId = `suxi-batch-2to8-top1-${Date.now()}`;
